...
- (instancetype)initWithViewControllers:(NSArray<UIViewController *> *__nullable)viewControllers tabBarItemsAttributes:(NSArray<NSDictionary *> *)tabBarItemsAttributes {
...
- (void)cyl_setTabBarController:(CYLTabBarController *__nullable)tabBarController {
