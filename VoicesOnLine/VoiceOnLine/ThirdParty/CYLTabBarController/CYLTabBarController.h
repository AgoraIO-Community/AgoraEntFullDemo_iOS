...
@interface CYLTabBarController : QMUITabBarViewController <CYLTabBarControllerDelegate>
...
- (instancetype)initWithViewControllers:(NSArray<UIViewController *> *__nullable)viewControllers
                  tabBarItemsAttributes:(NSArray<NSDictionary *> *)tabBarItemsAttributes;

+ (instancetype)tabBarControllerWithViewControllers:(NSArray<UIViewController *> *__nullable)viewControllers
                              tabBarItemsAttributes:(NSArray<NSDictionary *> *)tabBarItemsAttributes;
...
- (instancetype)initWithViewControllers:(NSArray<UIViewController *> *__nullable)viewControllers
                  tabBarItemsAttributes:(NSArray<NSDictionary *> *)tabBarItemsAttributes
                            imageInsets:(UIEdgeInsets)imageInsets
                titlePositionAdjustment:(UIOffset)titlePositionAdjustment
                                context:(NSString *__nullable)context;
...
- (void)updateSelectionStatusIfNeededForTabBarController:(UITabBarController *__nullable)tabBarController shouldSelectViewController:(UIViewController *__nullable)viewController;

- (void)updateSelectionStatusIfNeededForTabBarController:(UITabBarController *__nullable)tabBarController shouldSelectViewController:(UIViewController *__nullable)viewController shouldSelect:(BOOL)shouldSelect;
 ...
 */
@property (nonatomic, setter=cyl_setTabBarController:) CYLTabBarController *__nullable cyl_tabBarController;
