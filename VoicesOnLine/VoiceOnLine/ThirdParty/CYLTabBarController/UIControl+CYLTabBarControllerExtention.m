...
//- (void)cyl_addLottieImageWithLottieFilePath:(NSString *)lottiePath
//                                   size:(CGSize)size {
//#if __has_include(<Lottie/Lottie.h>)
...
//    animationView.frame = CGRectMake(0, 0, size.width, size.height);
//    animationView.contentMode = UIViewContentModeScaleAspectFit;
//    animationView.userInteractionEnabled = NO;
////    animationView.contentMode = UIViewContentModeScaleAspectFill;
//    animationView.translatesAutoresizingMaskIntoConstraints = NO;
//    [animationView setClipsToBounds:NO];
////    animationView.backgroundColor = [UIColor clearColor];
////    animationView.animationSpeed = 1;
//    [tabButton cyl_replaceTabImageViewWithNewView:animationView show:YES];
//#else
//#endif
//
//}
...
- (void)cyl_addLottieImageWithLottieURL:(NSURL *)lottieURL
    ...
    ///var/containers/Bundle/Application/242DA0B7-6D0D-4980-95B8-FD77517811BB/VoiceOnLineTest.app/Lottie.bundle/Publish/publish.json
    ///file:///private/var/containers/Bundle/Application/6641FA1D-91A5-447F-8C91-B3B7C8ADBE3A/VoiceOnLineTest.app/tab_home_animate.json
...
//    [lottieView setClipsToBounds:NO];
    ...
    NSString *fiex = @"file://";
    NSString *path = [lottieURL absoluteString];
    NSString *filePath = [path substringFromIndex:fiex.length];
