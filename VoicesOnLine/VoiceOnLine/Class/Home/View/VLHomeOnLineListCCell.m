...
- (void)setupView {
    ...
    self.lockImgView.image = UIImageMake(@"online_list_lockIcon");
    ...
    self.onListIconView.image = UIImageMake(@"online_list_countIcon");
...
- (void)setListModel:(VLRoomListModel *)listModel {
    ...
    self.bgImgView.image = UIImageMake(@"online_list_itemBgIcon");
