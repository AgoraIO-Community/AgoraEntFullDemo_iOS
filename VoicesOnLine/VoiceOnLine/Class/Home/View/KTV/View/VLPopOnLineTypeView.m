...
- (void)setupView {
    ...
    [backBtn setImage:UIImageMake(@"ktv_back_whiteIcon") forState:UIControlStateNormal];
    ...
    QMUIButton *audioBtn = [[QMUIButton alloc] qmui_initWithImage:UIImageMake(@"KTV_onLineType_audionIcon") title:NSLocalizedString(@"音频上麦", nil)];
    ...
    self.audioSelImgView.image = UIImageMake(@"ktv_selbg_icon");
    self.audioSelImgView.hidden = YES;
    [self addSubview:self.audioSelImgView];
    
    QMUIButton *videoBtn = [[QMUIButton alloc] qmui_initWithImage:UIImageMake(@"KTV_onLineType_videoIcon") title:NSLocalizedString(@"视频上麦", nil)];
    ...
    self.videoSelImgView.image = UIImageMake(@"ktv_selbg_icon");
