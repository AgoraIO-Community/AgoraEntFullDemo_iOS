...
- (void)setupView{
    ...
    searchIcon.image = UIImageMake(@"ktv_search_icon");
    ...
    [clearButton setImage:UIImageMake(@"ktv_search_clearIcon") forState:UIControlStateNormal];
    [clearButton setImage:UIImageMake(@"ktv_search_clearIcon") forState:UIControlStateHighlighted];
    [clearButton setImage:UIImageMake(@"ktv_search_clearIcon") forState:UIControlStateSelected];
