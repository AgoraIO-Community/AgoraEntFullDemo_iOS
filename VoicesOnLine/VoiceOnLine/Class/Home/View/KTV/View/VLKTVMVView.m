...
- (void)setupView {
    ...
    self.bgImgView.image = UIImageMake(@"ktv_mv_tempBg");
    ...
    currentPlayImgView.image = UIImageMake(@"ktv_currentPlay_icon");
...
- (void)changeBgViewByModel:(VLKTVSelBgModel *)selBgModel {
    self.bgImgView.image = UIImageMake(selBgModel.imageName);
}
...
- (VLHotSpotBtn *)pauseBtn {
    if (!_pauseBtn) {
        ...
        [_pauseBtn setImage:UIImageMake(@"ktv_pause_icon") forState:UIControlStateSelected];
        [_pauseBtn setImage:UIImageMake(@"ktv_pause_resumeicon") forState:UIControlStateNormal];
...
- (VLHotSpotBtn *)nextButton {
    if (!_nextButton) {
        ...
        [_nextButton setImage:UIImageMake(@"ktv_playNext_icon") forState:UIControlStateNormal];
...
- (QMUIButton *)originBtn {
    if (!_originBtn) {
        _originBtn = [[QMUIButton alloc] qmui_initWithImage:UIImageMake(@"") title:NSLocalizedString(@"原唱", nil)];
...
- (VLHotSpotBtn *)subtitleBtn {
    if (!_subtitleBtn) {
        ...
        [_subtitleBtn setImage:UIImageMake(@"ktv_subtitle_icon") forState:UIControlStateNormal];
