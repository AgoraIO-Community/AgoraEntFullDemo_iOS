...
- (void)setUpView {
    ...
    self.picImgView.image = UIImageMake(@"online_temp_icon");
...
//    [self addSubview:self.typeLabel];
    ...
    [self.deleteBtn setImage:UIImageMake(@"ktv_delete_icon") forState:UIControlStateNormal];
    ...
    [self.sortBtn setImage:UIImageMake(@"ktv_sort_icon") forState:UIControlStateNormal];
    ...
    self.singingBtn = [[QMUIButton alloc] qmui_initWithImage:UIImageMake(@"ktv_singing_icon") title:NSLocalizedString(@"演唱中", nil)];
