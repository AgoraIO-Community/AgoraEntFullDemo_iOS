...
- (void)setupView {
    ...
    QMUIButton *randomBtn = [[QMUIButton alloc] qmui_initWithImage:UIImageMake(@"online_create_randomIcon") title:NSLocalizedString(@"随机", nil)];
    ...
    QMUIButton *publicBtn = [[QMUIButton alloc] qmui_initWithImage:UIImageMake(@"online_create_screatNormalIcon") title:NSLocalizedString(@"公开", nil)];
    ...
    [publicBtn setImage:UIImageMake(@"online_create_screatNormalIcon") forState:UIControlStateNormal];
    [publicBtn setImage:UIImageMake(@"online_create_screatSelIcon") forState:UIControlStateSelected];
    publicBtn.tag = 0;
    ...
    QMUIButton *screatBtn = [[QMUIButton alloc] qmui_initWithImage:UIImageMake(@"online_create_screatNormalIcon") title:NSLocalizedString(@"加密", nil)];
    ...
    [screatBtn setImage:UIImageMake(@"online_create_screatNormalIcon") forState:UIControlStateNormal];
    [screatBtn setImage:UIImageMake(@"online_create_screatSelIcon") forState:UIControlStateSelected];
    screatBtn.tag = 1;
...
//    本应用为测试产品，请勿商用
    ...
    tipImgView.image = UIImageMake(@"online_create_tipIcon");
